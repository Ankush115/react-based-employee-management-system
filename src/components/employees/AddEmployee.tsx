    ...
    <div className="page-shell">
      <div className="content-card">
        <div className="page-header">
          <div>
            <h1>Add Employee</h1>
            <p className="page-subtitle">Create a new team member and add them to your employee roster.</p>
          </div>
        </div>
        ...
        <form className="form-card" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-actions">
            ...
            <button className="secondary-button" type="button" onClick={() => navigate("/employees")}>Cancel</button>
          </div>
        </form>
      </div>
    </div>
